...
<form method="POST" action="{{ route('login') }}" class="custom_form" novalidate>
    ...
    <div class="form-group mb-3">
        ...
        <input id="username" type="text" name="username" value="{{ old('username') }}" required autocomplete="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" autofocus placeholder="Enter your username">
        @error('username')
...
<div class="row mt-3">
    <div class="col-12 text-center">
        ...
        <a class="text-white ml-1" href="{{ route('password.request') }}">Forgot Your Password?</a>
        @endif
    </div> <!-- end col -->
</div>
@endsection