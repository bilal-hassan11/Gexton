        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1 text-center">
                <div class="error_page footer_apps_widget">
                    @hasSection('icon')
                        <img class="img-fluid" src="{{ asset('frontend_assets') }}/img/resource/@yield('icon')" alt="error.png">
                    @else
                        <img class="img-fluid" src="{{ asset('frontend_assets') }}/img/resource/general_error.png" alt="error.png">
                    @endif
