                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" onclick="ajaxRequest(this)" data-url="{{ route('permissions.delete', $permission->hashid) }}"  class="btn btn-danger btn-xs waves-effect waves-light">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="ajaxForm" action="{{route('permissions.save')}}" method="POST">
                    @csrf
