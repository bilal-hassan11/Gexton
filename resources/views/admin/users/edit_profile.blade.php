...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form action="{{ route('save_profile') }}" class="ajaxForm" method="post" enctype="multipart/form-data" novalidate>
                @csrf
                @if($user->image)
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" disabled placeholder="Enter email" class="form-control" id="email" value="{{ $user->email ?? '' }}">
                </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <form action="{{ route('change_password') }}" class="ajaxForm" method="post">
                @csrf
                <div class="form-group mb-3">
